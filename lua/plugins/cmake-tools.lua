return {
  ...
  opts = {
    ...
    --       ${kitGenerator}
    --       ${variant:xx}
    cmake_build_directory = "bin/${variant:buildType}", -- this is used to specify generate directory for cmake, allows macro expansion, can be a string or a function returning the string, relative to cwd.
